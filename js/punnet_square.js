...
function nigawork() {
  ...
  if (
    ...
    finp.length % 2 == 1 ||
    secinp.length % 2 == 1 || !"aabbccddeeffgghh".includes(finp.toLowerCase())|| !"aabbccddeeffgghh".includes(secinp.toLowerCase())
  ) {
    ...
    for (let i = 0; i < x; i++) {
      ...
      for (let k = 0; k < phinp.length; k++) {
        if (checkbox.checked == true) {
          ...
          if (
            variants[j][i].includes(
              phinp[k].toUpperCase() + phinp[k].toLowerCase()
            ) &&
